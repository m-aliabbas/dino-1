...
class PROJHead(nn.Module):
    def __init__(self, in_dim, out_dim, nlayers=3, hidden_dim=2048, bottleneck_dim=256):
        ...
        Args:
            ...
            hidden_dim (int, optional): The dimension of the hidden layers. Defaults to 2048.
            bottleneck_dim (int, optional): The dimension of the bottleneck layer. Defaults to 256.
        """
        super().__init__()
